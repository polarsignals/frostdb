...
func (x *Entry) GetCompaction() *Entry_Compaction {
	if x, ok := x.GetEntryType().(*Entry_Compaction_); ok {
		return x.Compaction
	}
	return nil
}
...
type Entry_Compaction_ struct {
	// Compaction is set if the entry describes a compaction.
	Compaction *Entry_Compaction `protobuf:"bytes,5,opt,name=compaction,proto3,oneof"`
}
...
func (*Entry_Compaction_) isEntry_EntryType() {}
...
func (x *Entry_Write) GetTx() uint64 {
	if x != nil {
		return x.Tx
	}
	return 0
...
type Entry_Compaction struct {
	...
	Transactions map[uint64]bool `protobuf:"bytes,2,rep,name=transactions,proto3" json:"transactions,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
func (x *Entry_Compaction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Entry_Compaction) ProtoMessage() {}

func (x *Entry_Compaction) ProtoReflect() protoreflect.Message {
	mi := &file_frostdb_wal_v1alpha1_wal_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Entry_Compaction.ProtoReflect.Descriptor instead.
func (*Entry_Compaction) Descriptor() ([]byte, []int) {
	return file_frostdb_wal_v1alpha1_wal_proto_rawDescGZIP(), []int{1, 1}
}

func (x *Entry_Compaction) GetTableName() string {
	if x != nil {
		return x.TableName
	}
	return ""
...
func (x *Entry_Compaction) GetTransactions() map[uint64]bool {
	if x != nil {
...
func (x *Entry_Compaction) GetLevel() uint32 {
	if x != nil {
		return x.Level
	}
	return 0
...
func (x *Entry_Compaction) GetOffset() int64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *Entry_Compaction) GetSize() int64 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *Entry_Snapshot) Reset() {
	*x = Entry_Snapshot{}
	if protoimpl.UnsafeEnabled {
		mi := &file_frostdb_wal_v1alpha1_wal_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Entry_Snapshot) Descriptor() ([]byte, []int) {
	return file_frostdb_wal_v1alpha1_wal_proto_rawDescGZIP(), []int{1, 4}
}
...
var file_frostdb_wal_v1alpha1_wal_proto_rawDesc = []byte{
	...
	0x79, 0x52, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0xfd,
	0x07, 0x0a, 0x05, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x39, 0x0a, 0x05, 0x77, 0x72, 0x69, 0x74,
	...
	0x68, 0x6f, 0x74, 0x12, 0x48, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x66, 0x72, 0x6f, 0x73, 0x74, 0x64,
	0x62, 0x2e, 0x77, 0x61, 0x6c, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x48,
	0x00, 0x52, 0x0a, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x50, 0x0a,
	0x05, 0x57, 0x72, 0x69, 0x74, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f,
	...
	,
	...
	0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x1a, 0x3f, 0x0a,
	...
	0x01, 0x28, 0x08, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x92,
	0x01, 0x0a, 0x0d, 0x4e, 0x65, 0x77, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	...
	,
...
var file_frostdb_wal_v1alpha1_wal_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_frostdb_wal_v1alpha1_wal_proto_goTypes = []interface{}{
	...
	(*Entry_Compaction)(nil),          // 3: frostdb.wal.v1alpha1.Entry.Compaction
	(*Entry_NewTableBlock)(nil),       // 4: frostdb.wal.v1alpha1.Entry.NewTableBlock
	(*Entry_TableBlockPersisted)(nil), // 5: frostdb.wal.v1alpha1.Entry.TableBlockPersisted
	(*Entry_Snapshot)(nil),            // 6: frostdb.wal.v1alpha1.Entry.Snapshot
	nil,                               // 7: frostdb.wal.v1alpha1.Entry.Compaction.TransactionsEntry
	(*v1alpha1.TableConfig)(nil),      // 8: frostdb.table.v1alpha1.TableConfig
}
var file_frostdb_wal_v1alpha1_wal_proto_depIdxs = []int32{
	...
	4, // 2: frostdb.wal.v1alpha1.Entry.new_table_block:type_name -> frostdb.wal.v1alpha1.Entry.NewTableBlock
	5, // 3: frostdb.wal.v1alpha1.Entry.table_block_persisted:type_name -> frostdb.wal.v1alpha1.Entry.TableBlockPersisted
	6, // 4: frostdb.wal.v1alpha1.Entry.snapshot:type_name -> frostdb.wal.v1alpha1.Entry.Snapshot
	3, // 5: frostdb.wal.v1alpha1.Entry.compaction:type_name -> frostdb.wal.v1alpha1.Entry.Compaction
	7, // 6: frostdb.wal.v1alpha1.Entry.Compaction.transactions:type_name -> frostdb.wal.v1alpha1.Entry.Compaction.TransactionsEntry
	8, // 7: frostdb.wal.v1alpha1.Entry.NewTableBlock.config:type_name -> frostdb.table.v1alpha1.TableConfig
...
func file_frostdb_wal_v1alpha1_wal_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_frostdb_wal_v1alpha1_wal_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
